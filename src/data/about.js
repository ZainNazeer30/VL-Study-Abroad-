...
export const ABOUT_VALUES = [
  { icon: 'advice', t: 'Honest, personal advice', d: 'One counsellor who knows your file and tells you the truth about your chances.' },
  { icon: 'process', t: 'A clear process', d: 'Set fees, set timelines and a way to track your applications any time.' },
  { icon: 'local', t: 'Deep local knowledge', d: 'We only work with Italy and France, so we know Universitaly, DSU, Campus France and CROUS well.' },
  { icon: 'departure', t: 'With you the whole way', d: 'From the first call to your first week on campus, including housing, permits and a bank account.' },
]
